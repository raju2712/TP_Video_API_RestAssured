...
public class GetParticularAddress {
	...
	public void getParticularAddress() {
		...
		given().auth().oauth2(authToken).relaxedHTTPSValidation().when()
		.get("https://www.shoppersstack.com/shopping/shoppers/235453/address/111348").then().log().all();
	}
}
